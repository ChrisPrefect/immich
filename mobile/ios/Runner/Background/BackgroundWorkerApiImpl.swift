...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  private static let refreshTaskID = "app.iteconomy.immich.background.refreshUpload"
  private static let processingTaskID = "app.iteconomy.immich.background.processingUpload"
