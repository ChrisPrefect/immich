...
class BackgroundServicePlugin: NSObject, FlutterPlugin {
    ...
    // e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"app.iteconomy.immich.backgroundFetch"]
    // or
    // e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"app.iteconomy.immich.backgroundProcessing"]
    ...
    // In my tests, I can only get app.iteconomy.immich.backgroundProcessing simulated by running the above command
    
    // This is the task ID in Info.plist to register as our background task ID
    public static let backgroundFetchTaskID = "app.iteconomy.immich.backgroundFetch"
    public static let backgroundProcessingTaskID = "app.iteconomy.immich.backgroundProcessing"
