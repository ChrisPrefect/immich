...
class NativeSyncApi {
  ...
  Future<void> setIncludeHiddenAssets(bool includeHiddenAssets) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.immich_mobile.NativeSyncApi.setIncludeHiddenAssets$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[includeHiddenAssets]);
